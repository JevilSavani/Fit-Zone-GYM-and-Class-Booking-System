...
function LoginPage() {
    ...
    const [email, setEmail] = useState('member@fitzone.com');
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            login(data);
            navigate(data.role === 'Trainer' ? '/trainer' : data.role === 'Admin' ? '/admin' : '/classes');
        } catch (requestError) {
